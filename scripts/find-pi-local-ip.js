...
async function main() {
  const endpoints = [
    '/cgi-bin/userManager.cgi?action=getActiveUserInfo',
    '/cgi-bin/netApp.cgi?action=getArp',
    '/cgi-bin/netApp.cgi?action=getNetStatus',
    '/cgi-bin/configManager.cgi?action=getConfig&name=Arp',
    '/cgi-bin/log.cgi?action=getLog&count=20',
  ];
