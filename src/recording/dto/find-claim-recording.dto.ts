...
export class FindAndClaimRecordingDto {
  @ApiProperty({ description: 'The UUID of the Turf where the game was played' })
  @IsUUID()
  @IsNotEmpty()
  turfId: string;
  ...
  @ApiProperty({ description: 'Last 10 digits of the phone number of the person who started the recording' })
  @IsString()
  @IsNotEmpty()
  phoneLast10: string;
}
